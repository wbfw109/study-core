...
# Note that common interactive tool from https://storage.googleapis.com/coding-competitions.appspot.com/interactive_runner.py
#
...
if t_sol.return_code:
    print(
        "A solution finishing with exit code other than 0 (without exceeding "
