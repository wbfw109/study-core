...
python ./backend/object_detection_api_scripts/model_main.py \
--alsologtostderr \
--model_dir='/mnt/g/My Drive/shared_resource/training/' \
--pipeline_config_path='/mnt/g/My Drive/shared_resource/training/model-ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03/pipline_mine.config'
...
!pip install tf_slim
<version code>
%cd /content/drive/MyDrive/shared_resource
!python model_main.py --alsologtostderr --model_dir=training --pipeline_config_path=model-ssd_mobilenet_v2_quantized_300x300_coco_2019_01_03/pipline_mine_colab.config
"""
