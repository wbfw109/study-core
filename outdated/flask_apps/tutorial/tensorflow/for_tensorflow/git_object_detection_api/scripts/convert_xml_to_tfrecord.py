...
#####
from https://tensorflow-object-detection-api-tutorial.readthedocs.io/en/latest/training.html
...
def pascal_voc_xml_to_csv(path):
...
def main(_):
    ...
    examples = pascal_voc_xml_to_csv(args.xml_dir)
